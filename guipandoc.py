...
''' 2022-10-10 GUIでやるとpython知りませーンて人も使ってくれるかなと思ってたけど、
    結局そういう人はmarkdownもよくわかりませーンと言って使ってくれないという落ちだった。

    立ち上げっぱなしにしておくと対象リストを更新できないし、
    更新できるようにしてもいいけどそれを実装しても自分にとってはメリットはないので
    GUIはここらで更新停止にして、これ以降はコマンドラインで完結する cpan.py の方を整備していく。
